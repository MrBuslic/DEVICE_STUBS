...
int mwswitch_Socket_RPC_SLOT_Object::obj_num = 0;
int mwswitch_Socket_RPC_SIGNAL_Object::obj_num = 0;
int mwswitch_Socket_RPC_SIGNAL_Object::call_number = 0;
int mwswitch_Socket_RPC_SLOT_Thread::obj_num = 0;

	mwswitch_Socket_RPC_SIGNAL_Thread::mwswitch_Socket_RPC_SIGNAL_Thread() : QThread()
	{
		setObjectName("mwswitch_Socket_RPC_SIGNAL_Thread");
	}

	void mwswitch_Socket_RPC_SIGNAL_Thread::run()
	{
		rpc_srv = new mwswitch_Socket_RPC_SIGNAL_Server(conn_ip, conn_port);
		rpc_srv->set_app(app);
		SRPCSignalClass::Instance().toLog("mwswitch signal thread started");
		exec();
	}

	mwswitch_Socket_RPC_SIGNAL_Server::mwswitch_Socket_RPC_SIGNAL_Server(QString _conn_ip, int _conn_port)
	{
	...
	void mwswitch_Socket_RPC_SIGNAL_Server::tcp_slot()
	{
		SRPCSignalClass::Instance().toLog("mwswitch signal client connected");
		std::shared_ptr<mwswitch_Socket_RPC_SIGNAL_Object> tmp_obj(new mwswitch_Socket_RPC_SIGNAL_Object);
		tmp_obj->set_app(app);
		tmp_obj->set_socket(rpc_server->nextPendingConnection());
		rpc_objects << tmp_obj;
	}

	mwswitch_Socket_RPC_SLOT_Server_Thread::mwswitch_Socket_RPC_SLOT_Server_Thread() : QThread()
	{
		setObjectName("Socket_RPC_SLOT_Server_Thread");
	}

	mwswitch_Socket_RPC_SLOT_Server::mwswitch_Socket_RPC_SLOT_Server(QString _conn_ip, int _conn_port, RpcMWSwitchWidget* _app) : QTcpServer(), app(_app)
	{
	...
	void mwswitch_Socket_RPC_SLOT_Server_Thread::run()
	{
		rpc_srv = new mwswitch_Socket_RPC_SLOT_Server(conn_ip, conn_port, app);
		SRPCSignalClass::Instance().toLog("mwswitch slot thread started");
		exec();
	}

	void mwswitch_Socket_RPC_SLOT_Thread::run()
	{
		rpc_obj = std::shared_ptr<mwswitch_Socket_RPC_SLOT_Object>(new mwswitch_Socket_RPC_SLOT_Object(app, socketDescriptor));
		exec();
	}

	mwswitch_Socket_RPC_SLOT_Thread::mwswitch_Socket_RPC_SLOT_Thread(RpcMWSwitchWidget* _app, int _socketDescriptor) : app(_app), socketDescriptor(_socketDescriptor)
	{
	setObjectName(QString("mwswitch_Socket_RPC_SLOT_Thread_%1").arg(obj_num++));
	}

	void mwswitch_Socket_RPC_SLOT_Server::incomingConnection(qintptr socketDescriptor)
	{
		SRPCSignalClass::Instance().toLog("mwswitch slot client connected");
		std::shared_ptr<mwswitch_Socket_RPC_SLOT_Thread> tmp_obj(new mwswitch_Socket_RPC_SLOT_Thread(app, socketDescriptor));
		tmp_obj->start();
		rpc_objects << tmp_obj;
	}

	mwswitch_Socket_RPC_SLOT_Object::mwswitch_Socket_RPC_SLOT_Object(RpcMWSwitchWidget* _app, int socketDescriptor) : QObject(), with_return(false), app(_app)
	{
	setObjectName(QString("mwswitch_SLOT_Object_%1").arg(obj_num++));
		operators_map["QuerySlots()"] = &mwswitch_Socket_RPC_SLOT_Object::QuerySlots;
		///////////////////////////////////////////////////////////////////////
		///////////////////////////////////////////////////////////////////////
		///////////////////////////////////////////////////////////////////////
	...
	mwswitch_Socket_RPC_SIGNAL_Object::mwswitch_Socket_RPC_SIGNAL_Object() : QObject()
	{
		setObjectName(QString("mwswitch_SIGNAL_Object_%1").arg(obj_num++));
		connect(this, SIGNAL(send_signal(QByteArray*)), this, SLOT(send_signal_slot(QByteArray*)), Qt::BlockingQueuedConnection);
	}

	void mwswitch_Socket_RPC_SIGNAL_Object::send_signal_func(QByteArray* _arr)
	{
		QMutexLocker locker(&signal_mutex);
		emit send_signal(_arr);
	}

	void mwswitch_Socket_RPC_SLOT_Object::sock_error(QAbstractSocket::SocketError _err)
	{
		SRPCSignalClass::Instance().toLog(QString("%1 SLOT SOCK ERROR!!! %2").arg(this->objectName()).arg(_err));
	}

	void mwswitch_Socket_RPC_SIGNAL_Object::set_socket(QTcpSocket* _rpc_socket)
	{
	...
	void mwswitch_Socket_RPC_SIGNAL_Object::sock_error(QAbstractSocket::SocketError _err)
	{
	...
	void mwswitch_Socket_RPC_SIGNAL_Object::set_app(RpcMWSwitchWidget* _app)
	{
		app = _app;

	}

	void mwswitch_Socket_RPC_SLOT_Object::read_data()
	{
		//LARGE_INTEGER _freq;
		//LARGE_INTEGER tmp1;
		//LARGE_INTEGER tmp2;
	...
	void mwswitch_Socket_RPC_SIGNAL_Object::send_signal_slot(QByteArray* _arr)
	{
		rpc_socket->write(*_arr);
		rpc_socket->waitForBytesWritten(3000);
	}

	void mwswitch_Socket_RPC_SIGNAL_Object::read_data()
	{
		int tmp_size;
...
//				data_map[signal_name]->cond.wakeAll();
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	QVariant mwswitch_Socket_RPC_SLOT_Object::QuerySlots(QVariantList& _values)
	{
		QString tmp_string;
