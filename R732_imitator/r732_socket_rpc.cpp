...
int r732_Socket_RPC_SIGNAL_Object::call_number = 0;
	...
	{
		setObjectName("r732_Socket_RPC_SIGNAL_Thread");
	}

	void r732_Socket_RPC_SIGNAL_Thread::run()
	{
		rpc_srv = new r732_Socket_RPC_SIGNAL_Server(conn_ip, conn_port);
		rpc_srv->set_app(app);
		SRPCSignalClass::Instance().toLog("r732 signal thread started");
		exec();
	}

	r732_Socket_RPC_SIGNAL_Server::r732_Socket_RPC_SIGNAL_Server(QString _conn_ip, int _conn_port)
	{
	...
	void r732_Socket_RPC_SIGNAL_Server::tcp_slot()
	{
		SRPCSignalClass::Instance().toLog("r732 signal client connected");
		std::shared_ptr<r732_Socket_RPC_SIGNAL_Object> tmp_obj(new r732_Socket_RPC_SIGNAL_Object);
		tmp_obj->set_app(app);
		tmp_obj->set_socket(rpc_server->nextPendingConnection());
		rpc_objects << tmp_obj;
	}

	r732_Socket_RPC_SLOT_Server_Thread::r732_Socket_RPC_SLOT_Server_Thread() : QThread()
	{
		setObjectName("Socket_RPC_SLOT_Server_Thread");
	}

	r732_Socket_RPC_SLOT_Server::r732_Socket_RPC_SLOT_Server(QString _conn_ip, int _conn_port, R732_widg* _app) : QTcpServer(), app(_app)
	{
	...
	void r732_Socket_RPC_SLOT_Server_Thread::run()
	{
		rpc_srv = new r732_Socket_RPC_SLOT_Server(conn_ip, conn_port, app);
		SRPCSignalClass::Instance().toLog("r732 slot thread started");
		exec();
	}

	void r732_Socket_RPC_SLOT_Thread::run()
	{
		rpc_obj = std::shared_ptr<r732_Socket_RPC_SLOT_Object>(new r732_Socket_RPC_SLOT_Object(app, socketDescriptor));
		exec();
	}
	...
	{
		SRPCSignalClass::Instance().toLog("r732 slot client connected");
		std::shared_ptr<r732_Socket_RPC_SLOT_Thread> tmp_obj(new r732_Socket_RPC_SLOT_Thread(app, socketDescriptor));
		tmp_obj->start();
		rpc_objects << tmp_obj;
	}

	r732_Socket_RPC_SLOT_Object::r732_Socket_RPC_SLOT_Object(R732_widg* _app, int socketDescriptor) : QObject(), with_return(false), app(_app)
	{
	setObjectName(QString("r732_SLOT_Object_%1").arg(obj_num++));
		operators_map["QuerySlots()"] = &r732_Socket_RPC_SLOT_Object::QuerySlots;
		///////////////////////////////////////////////////////////////////////
		operators_map["new_message(QVariant, int, int, int, QVariantList, int)"] = &r732_Socket_RPC_SLOT_Object::new_message;
		operators_map["set_new_mbk02_tm(int, int)"] = &r732_Socket_RPC_SLOT_Object::set_new_mbk02_tm;
		operators_map["get_power(double)"] = &r732_Socket_RPC_SLOT_Object::get_power;
		operators_map["new_mk(int, int, int, int, double, double, int, int, int)"] = &r732_Socket_RPC_SLOT_Object::new_mk;
		operators_map["new_kpi(QVariantList)"] = &r732_Socket_RPC_SLOT_Object::new_kpi;
		///////////////////////////////////////////////////////////////////////
		///////////////////////////////////////////////////////////////////////
	...
	r732_Socket_RPC_SIGNAL_Object::r732_Socket_RPC_SIGNAL_Object() : QObject()
	{
		setObjectName(QString("r732_SIGNAL_Object_%1").arg(obj_num++));
		connect(this, SIGNAL(send_signal(QByteArray*)), this, SLOT(send_signal_slot(QByteArray*)), Qt::BlockingQueuedConnection);
	}

	void r732_Socket_RPC_SIGNAL_Object::send_signal_func(QByteArray* _arr)
	{
		QMutexLocker locker(&signal_mutex);
		emit send_signal(_arr);
	}

	void r732_Socket_RPC_SLOT_Object::sock_error(QAbstractSocket::SocketError _err)
	{
		SRPCSignalClass::Instance().toLog(QString("%1 SLOT SOCK ERROR!!! %2").arg(this->objectName()).arg(_err));
	}

	void r732_Socket_RPC_SIGNAL_Object::set_socket(QTcpSocket* _rpc_socket)
	{
	...
	void r732_Socket_RPC_SIGNAL_Object::sock_error(QAbstractSocket::SocketError _err)
	{
	...
	void r732_Socket_RPC_SIGNAL_Object::set_app(R732_widg* _app)
	{
		app = _app;
	...
	void r732_Socket_RPC_SLOT_Object::read_data()
	{
		//LARGE_INTEGER _freq;
		//LARGE_INTEGER tmp1;
		//LARGE_INTEGER tmp2;
	...
	void r732_Socket_RPC_SIGNAL_Object::send_signal_slot(QByteArray* _arr)
	{
		rpc_socket->write(*_arr);
		rpc_socket->waitForBytesWritten(3000);
	}

	void r732_Socket_RPC_SIGNAL_Object::read_data()
	{
		int tmp_size;
...
//				data_map[signal_name]->cond.wakeAll();
	...
	void r732_Socket_RPC_SIGNAL_Object::new_ku(int ku_n, int length, double u, int line)
	{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	QVariant r732_Socket_RPC_SLOT_Object::QuerySlots(QVariantList& _values)
	{
		QString tmp_string;
	...
	QVariant r732_Socket_RPC_SLOT_Object::new_message(QVariantList& _values)
	{
		try
		{
	...
	QVariant r732_Socket_RPC_SLOT_Object::set_new_mbk02_tm(QVariantList& _values)
	{
		try
		{
			SRPCSignalClass::Instance().toLog(QString("%1 _values = %2").arg(objectName()).arg(RPCSignalClass::QVariantToString(_values)));
	...
	QVariant r732_Socket_RPC_SLOT_Object::get_power(QVariantList& _values)
	{
		try
		{
			SRPCSignalClass::Instance().toLog(QString("%1 _values = %2").arg(objectName()).arg(RPCSignalClass::QVariantToString(_values)));
	...
	QVariant r732_Socket_RPC_SLOT_Object::new_mk(QVariantList& _values)
	{
		try
		{
			SRPCSignalClass::Instance().toLog(QString("%1 _values = %2").arg(objectName()).arg(RPCSignalClass::QVariantToString(_values)));
	...
	QVariant r732_Socket_RPC_SLOT_Object::new_kpi(QVariantList& _values)
	{
		try
		{
			SRPCSignalClass::Instance().toLog(QString("%1 _values = %2").arg(objectName()).arg(RPCSignalClass::QVariantToString(_values)));
