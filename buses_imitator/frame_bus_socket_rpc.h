...
class Socket_RPC_SLOT_Object : public QObject
{
	Q_OBJECT
public:
	Socket_RPC_SLOT_Object(FrameBusWidget* _app, int socketDescriptor);
...
class Socket_RPC_SLOT_Thread : public QThread
{
	Q_OBJECT
public:
	Socket_RPC_SLOT_Thread(FrameBusWidget* _app, int _socketDescriptor);
	void run();
...
class Socket_RPC_SLOT_Server : public QTcpServer
{
	Q_OBJECT
public:
	Socket_RPC_SLOT_Server(QString _conn_ip, int _conn_port, FrameBusWidget* _app);
protected:
