...
int Socket_RPC_SIGNAL_Object::call_number = 0;
	...
	Socket_RPC_SLOT_Server::Socket_RPC_SLOT_Server(QString _conn_ip, int _conn_port, InterruptWidget* _app) : QTcpServer(), app(_app)
	{
	...
	Socket_RPC_SLOT_Thread::Socket_RPC_SLOT_Thread(InterruptWidget* _app, int _socketDescriptor) : app(_app), socketDescriptor(_socketDescriptor)
	{}
	...
	Socket_RPC_SLOT_Object::Socket_RPC_SLOT_Object(InterruptWidget* _app, int socketDescriptor) : QObject(), with_return(false), app(_app)
	{
	setObjectName(QString("interrupt_bus_SLOT_Object_%1").arg(obj_num++));
		operators_map["QuerySlots()"] = &Socket_RPC_SLOT_Object::QuerySlots;
		///////////////////////////////////////////////////////////////////////
		operators_map["make_interrupt(int, short, double, double)"] = &Socket_RPC_SLOT_Object::make_interrupt;
		///////////////////////////////////////////////////////////////////////
		///////////////////////////////////////////////////////////////////////
	...
	void Socket_RPC_SIGNAL_Object::set_app(InterruptWidget* _app)
	{
		app = _app;
...
//				data_map[signal_name]->cond.wakeAll();
	...
	void Socket_RPC_SIGNAL_Object::new_interrupt(int _n, short _chan, double _u, double _t)
	{
	...
	QVariant Socket_RPC_SLOT_Object::make_interrupt(QVariantList& _values)
	{
		try
		{
