...
while (Size--) Crc32 = (Crc32 >> 8) ^ Crc32Table[(*DataBuffer++ ^ Crc32) & 0xFF];
...
Crc16 = 0xFFFF;
DataBuffer = (BYTE*) Buffer;
while (Size--) Crc16 = (Crc16 << 8) ^ Crc16Table[*DataBuffer++ ^ (Crc16 >> 8)];
...
Crc8 = 0xFF;
DataBuffer = (BYTE*) Buffer;
while (Size--) Crc8 = Crc8Table[Crc8 ^ *DataBuffer++];
