...
RpcMKPRMWidget::RpcMKPRMWidget() : QWidget(), working(false)
{
	...
	mkprm_Socket_RPC_SLOT_Server_Thread* rpc_slot_srv = new mkprm_Socket_RPC_SLOT_Server_Thread;
	rpc_slot_srv->set_app(this);
	rpc_slot_srv->set_params(ip_str, slot_port);
	rpc_slot_srv->start();
	mkprm_Socket_RPC_SIGNAL_Thread* rpc_signal_srv = new mkprm_Socket_RPC_SIGNAL_Thread;
