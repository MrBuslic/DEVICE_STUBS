...
int Socket_RPC_SIGNAL_Object::obj_num = 0;
	...
	Socket_RPC_SLOT_Server::Socket_RPC_SLOT_Server(QString _conn_ip, int _conn_port, RpcADS128Widget* _app) : QTcpServer(), app(_app)
	{
	...
	Socket_RPC_SLOT_Thread::Socket_RPC_SLOT_Thread(RpcADS128Widget* _app, int _socketDescriptor) : app(_app), socketDescriptor(_socketDescriptor)
	{}
	...
	Socket_RPC_SLOT_Object::Socket_RPC_SLOT_Object(RpcADS128Widget* _app, int socketDescriptor) : QObject(), with_return(false), app(_app)
	{
