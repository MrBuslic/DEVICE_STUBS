...
int Socket_RPC_SIGNAL_Object::call_number = 0;
	...
	Socket_RPC_SLOT_Server::Socket_RPC_SLOT_Server(QString _conn_ip, int _conn_port, RpcOlsWidget* _app) : QTcpServer(), app(_app)
	{
	...
	Socket_RPC_SLOT_Thread::Socket_RPC_SLOT_Thread(RpcOlsWidget* _app, int _socketDescriptor) : app(_app), socketDescriptor(_socketDescriptor)
	{}
	...
	Socket_RPC_SLOT_Object::Socket_RPC_SLOT_Object(RpcOlsWidget* _app, int socketDescriptor) : QObject(), with_return(false), app(_app)
	{
	setObjectName(QString("ols_SLOT_Object_%1").arg(obj_num++));
		...
		operators_map["unols_write_data_kf(QVariantList, QVariantList)"] = &Socket_RPC_SLOT_Object::unols_write_data_kf;
		operators_map["unols_trigger_imm()"] = &Socket_RPC_SLOT_Object::unols_trigger_imm;
		///////////////////////////////////////////////////////////////////////
		///////////////////////////////////////////////////////////////////////
	...
	void Socket_RPC_SIGNAL_Object::set_app(RpcOlsWidget* _app)
	{
		app = _app;
...
//				data_map[signal_name]->cond.wakeAll();
	...
	void Socket_RPC_SIGNAL_Object::new_ols_data(QVariantList data_buffer, QVariantList mask_buffer)
	{
	...
	QVariant Socket_RPC_SLOT_Object::unols_write_data_kf(QVariantList& _values)
	{
		try
		{
			SRPCSignalClass::Instance().toLog(QString("%1 _values = %2").arg(objectName()).arg(RPCSignalClass::QVariantToString(_values)));
	...
	QVariant Socket_RPC_SLOT_Object::unols_trigger_imm(QVariantList& _values)
	{
		try
		{
