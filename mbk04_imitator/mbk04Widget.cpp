...
MainWidget::MainWidget()  
{
	...
	mbk04_Socket_RPC_SLOT_Server_Thread* rpc_slot_srv = new mbk04_Socket_RPC_SLOT_Server_Thread;
	rpc_slot_srv->set_app(this);
	rpc_slot_srv->set_params(ip_str, slot_port);
	rpc_slot_srv->start();
	mbk04_Socket_RPC_SIGNAL_Thread* rpc_signal_srv = new mbk04_Socket_RPC_SIGNAL_Thread;
