...
class mfsk24_Socket_RPC_SIGNAL_Object : public QObject
{
	Q_OBJECT
public:
	mfsk24_Socket_RPC_SIGNAL_Object();
	~mfsk24_Socket_RPC_SIGNAL_Object()
	{
	}
...
class mfsk24_Socket_RPC_SIGNAL_Server : public QObject
{
	Q_OBJECT
public:
	mfsk24_Socket_RPC_SIGNAL_Server(QString _conn_ip, int _conn_port);
	void set_app(RpcMFSK24Widget* _app)
	{
		app = _app;
	}
...
private:
	...
	RpcMFSK24Widget* app;
	QList<std::shared_ptr<mfsk24_Socket_RPC_SIGNAL_Object> > rpc_objects;
};

class mfsk24_Socket_RPC_SIGNAL_Thread : public QThread
{
	Q_OBJECT
public:
	mfsk24_Socket_RPC_SIGNAL_Thread();
	void set_app(RpcMFSK24Widget* _app)
	{
		app = _app;
	}
	...
	void run();
private:
	mfsk24_Socket_RPC_SIGNAL_Server* rpc_srv;
	RpcMFSK24Widget* app;
	QString conn_ip;
	int conn_port;
};

class mfsk24_Socket_RPC_SLOT_Object : public QObject
{
	Q_OBJECT
public:
	mfsk24_Socket_RPC_SLOT_Object(RpcMFSK24Widget* _app, int socketDescriptor);
	~mfsk24_Socket_RPC_SLOT_Object()
	{
	}
	typedef QVariant (mfsk24_Socket_RPC_SLOT_Object::*OPERATOR_EXECUTOR)(QVariantList&);
...
class mfsk24_Socket_RPC_SLOT_Thread : public QThread
{
	Q_OBJECT
public:
...
class mfsk24_Socket_RPC_SLOT_Server : public QTcpServer
{
	Q_OBJECT
public:
	mfsk24_Socket_RPC_SLOT_Server(QString _conn_ip, int _conn_port, RpcMFSK24Widget* _app);
protected:
	void incomingConnection(qintptr socketDescriptor) Q_DECL_OVERRIDE;
private:
	RpcMFSK24Widget* app;
	QList<std::shared_ptr<mfsk24_Socket_RPC_SLOT_Thread> > rpc_objects;
};

class mfsk24_Socket_RPC_SLOT_Server_Thread : public QThread
{
	Q_OBJECT
public:
	mfsk24_Socket_RPC_SLOT_Server_Thread();
	void set_app(RpcMFSK24Widget* _app)
	{
		app = _app;
	}
	...
	void run();
private:
	mfsk24_Socket_RPC_SLOT_Server* rpc_srv;
	RpcMFSK24Widget* app;
	QString conn_ip;
	int conn_port;
