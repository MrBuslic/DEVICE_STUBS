...
{
public:
	RPC_mfsk24_SLOT_Thread mfsk24_slot_thr;
	RPC_mfsk24_SIGNAL_Thread mfsk24_signal_thr;
};
...
{
	RPC_mfsk24_SLOT_Thread& slot_thr(Srpc_buffer_class::Instance().mfsk24_slot_thr);
	RPC_mfsk24_SIGNAL_Thread& signal_thr(Srpc_buffer_class::Instance().mfsk24_signal_thr);
...
ViStatus _VI_FUNC unmfsk24_set_cmd_time (ViSession line, ViInt16 chan,
										 ViReal64 time){
	return Srpc_buffer_class::Instance().mfsk24_slot_thr.get_mfsk24_obj()->unmfsk24_set_cmd_time(chan, time);
}
...
ViStatus _VI_FUNC unmfsk24_start (ViSession line, ViInt16 _VI_FAR state[]){ 
	...
	return Srpc_buffer_class::Instance().mfsk24_slot_thr.get_mfsk24_obj()->unmfsk24_start(tmp_state);
}
...
ViStatus _VI_FUNC unmfsk24_state (ViSession line, ViBoolean state[]){
	...
	QVariantList tmp_state;
	return Srpc_buffer_class::Instance().mfsk24_slot_thr.get_mfsk24_obj()->unmfsk24_state(tmp_state);
	for (int i = 0; i < 24; i++)
...
ViStatus _VI_FUNC unmfsk24_manual_cmd (ViSession line, ViInt16 chan, ViInt16 state_chan){ 
	return Srpc_buffer_class::Instance().mfsk24_slot_thr.get_mfsk24_obj()->unmfsk24_manual_cmd(chan, state_chan);
}
ViStatus _VI_FUNC unmfsk24_manual_group_cmd (ViSession line, ViInt16 state_chan,
	...
	return Srpc_buffer_class::Instance().mfsk24_slot_thr.get_mfsk24_obj()->unmfsk24_manual_group_cmd(state_chan, tmp_mass);
}
